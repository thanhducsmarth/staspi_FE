...
document.querySelector('.cont_icon_info').className = "cont_icon_info active-ft";    
c++; 
  }else{
document.querySelector('.cont_dropdown_info').className = "cont_dropdown_info disable";        
document.querySelector('.cont_icon_info').className = "cont_icon_info disable";        
c++;
  }
}
...
document.querySelector('.cont_icon_service').className = "cont_icon_service active-ft";    
s++; 
  }else{
document.querySelector('.cont_dropdown_service').className = "cont_dropdown_service disable";        
document.querySelector('.cont_icon_service').className = "cont_icon_service disable";        
s++;
  }
}
...
document.querySelector('.cont_icon_train').className = "cont_icon_train active-ft";    
s++; 
  }else{
document.querySelector('.cont_dropdown_train').className = "cont_dropdown_train disable";        
document.querySelector('.cont_icon_train').className = "cont_icon_train disable";        
s++;
  }
}